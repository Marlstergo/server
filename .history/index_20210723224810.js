...
const dbURI = 'mongodb+srv://maliq:maliq@cluster0.v6cc0.mongodb.net/employeesdb?retryWrites=true&w=majority'

app.use(cors());
const connectDB = async () => {
  await mongoose.connect(
    "mongodb+srv://maliq:maliq@cluster0.v6cc0.mongodb.net/employeesdb?retryWrites=true&w=majority",
    {
...
app.post("/createuser", async (req, res) => {
  ...
  // console.log(validation(req.body).error)
  if (error)
